...
// 0. Using the "use server" to not expose secret key
// 1. User enters full name and email
// 2. Check if the user already exist using the email (i will use this to identify if i still need to create a user document or not)
